  ...
  const features = [
    {
      ...
      title: "Ao seu ritmo",
      desc: "A nossa metodologia não prevê nenhuma atividade a horas especificas, tudo é feito ao seu ritmo.",
    },
    {
      icon: (
        <svg
      ...
      title: "Atua localmente",
      desc: "A nossa metodologia foi criada para permitir aos estudantes aplicarem os conhecimentos no local onde estão inseridos.",
    },
    {
      icon: (
        <svg
      ...
      title: "Certificado Conclusão",
      desc: "Enviamos o certificado de conclusão aos estudantes que concluírem pelo menos 80% das tarefas propostas.",
    },
  ];
