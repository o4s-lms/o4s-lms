  ...
  const radios = data?.methods
	...
	return (
		<div className="min-h-80 mx-auto my-4 w-full max-w-2xl sm:my-8">
			...
			<h2 className="font-medium text-gray-800 dark:text-gray-300">Selecione o método de pagamento</h2>
			{isLoading ? (
						...
						<li key={idx}>
							<label htmlFor={item.name} className="relative block">
								...
								<div className="flex w-full cursor-pointer items-start gap-x-3 rounded-lg border p-4 shadow-sm ring-indigo-600 duration-200 peer-checked:ring-2">
									...
									<div>
										<h3 className="pr-3 font-medium leading-none text-gray-800 dark:text-gray-300">
											{item.name}
										</h3>
								...
								<div className="dark:peer-checked:gray-800 absolute right-4 top-4 flex h-4 w-4 flex-none items-center justify-center rounded-full border text-white duration-200 peer-checked:bg-indigo-600 peer-checked:text-white dark:text-gray-800">
