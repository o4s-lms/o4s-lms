    ...
    return (
        <div className="mt-6 md:mt-0">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="mt-6 flex items-center gap-x-3">
                ...
                <Button className="block w-auto rounded-lg bg-blue-600 text-white shadow ring-blue-600 ring-offset-2 hover:bg-blue-500 focus:ring dark:bg-sky-500 dark:ring-sky-500 dark:hover:bg-sky-600">
                    Subscribe
                </Button>
            </form>
        </div>
